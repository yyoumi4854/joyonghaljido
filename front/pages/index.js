  ...
  return (
    <IndexStyles>
      ...
      <section className='sec bg'>
        ...
        <div className="textBox">
          <p>
            저희는 서울의 소음 문제에 집중하기로 했습니다.
            <br />
            <br />
            서울이 국내 타 지역에 비해 가장 높은 소음도를 보였기 때문입니다.
            <br />
            특히 조용해야 할 주택가조차 환경 기준의 약 10dB이나 초과하는
            수준이었죠.
            <br />
          </p>
        </div>
      ...
      <section className='sec'>
        ...
        <div className="textBox">
          <p>
            여기서 가장 중요한 점은 서울 내에서도 지역구마다 편차가 존재한다는
            점이었습니다.
            <br />
            강남구와 노원구의 소음 민원 수는 무려 7배 이상의 차이가 있었습니다.
            <br />
            <br />
            따라서 소음 문제가 제일 심각하면서도, 지역구별 차이가 있는 서울을
            타겟으로 하여
            <br />각 지역구와 동의 소음 정보를 가시화할 수 있는 서비스를
            제공하려고 합니다.
          </p>
        </div>
