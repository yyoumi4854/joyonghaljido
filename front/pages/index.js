    ...
    return (
        <IndexStyles>
            ...
            <div className='textBox'>
                ...
                <p>소음 공해는 미세먼지와 함께 <span className='strong'>환경을 위협하는 요인으로 지목</span>되고 있습니다.</p>     
            ...
            <div className='greenBox'>
                <div className='textBox2'>
                    ...
                    <p>저희는 <span className='strong'>서울의 소음 문제</span>에 집중하기로 했습니다.</p><br></br>
                    <p><span className='strong'>서울이 국내 타 지역에 비해 가장 높은 소음도</span>를 보였기 때문입니다.</p>
            ...
            <div className='textBox3'>
                ...
                <p>하지만 중요한 것은 <span className='strong'>서울 내에서도 지역구마다 편차가 존재한다는 점</span>이었습니다.</p>
                <p>강남구와 노원구의 소음 민원 수는 무려 7배 이상의 차이가 있었습니다.</p><br></br>
                <p>따라서 소음 문제가 제일 심각하면서도, 지역구별 차이가 있는 서울을 타겟으로 하여</p>
                <p><span className='strong'>각 지역구와 동의 소음 정보를 가시화할 수 있는 서비스</span>를 제공하려고 합니다.</p>
            </div>
