              ...
              ? pins &&
                pins.map((pin) => {
                  return (
                    ...
                    >
                      {pin.timeDecibelsAvg > 1 &&
                        pin.timeDecibelsAvg <= 50 &&
                        purplePin}
                      {pin.timeDecibelsAvg > 50 &&
                        pin.timeDecibelsAvg <= 55 &&
                        bluePin}
                      {pin.timeDecibelsAvg > 55 &&
                        pin.timeDecibelsAvg <= 60 &&
                        greenPin}
                      {pin.timeDecibelsAvg > 60 &&
                        pin.timeDecibelsAvg <= 65 &&
                        yellowPin}
                      {pin.timeDecibelsAvg > 65 &&
                        pin.timeDecibelsAvg <= 70 &&
                        orangePin}
                      {pin.timeDecibelsAvg > 70 && redPin}
                    </Marker>
                  );
                })
              : null}
