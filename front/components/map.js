        ...
        {currentState.currentView === "ranking" ? (
          ...
          <h2>
            ...
            {currentState.clickSpotId && (
              <>
                <BsForwardFill />
                <span className="hoverUp">{currentState.clickedName}</span>
              </>
            )}
          </h2>
        )}
                      ...
                      onClick={async () => {
                        ...
                        if (currentState.currentView === "ranking") {
                          ...
                          const mapData = await axios.get(
                            `http://localhost:5001/gus/${guId}`
                          );
                          const dongsAndPins = await axios.get(
                            `http://localhost:5001/location/gus/${guId}`
                          );
                  ...
                  return (
                    ...
                    >
                      <g transform="translate(-0, -5) scale(0.07)">
                        <path
                          d="M25.9078 59.0345C25.5502 59.8087 24.4498 59.8087 24.0922 59.0345L18.7274 47.4193C18.4213 46.7567 18.9053 46 19.6352 46H30.3648C31.0947 46 31.5787 46.7567 31.2727 47.4193L25.9078 59.0345Z"
                          fill="#7352DE"
                        />
                        <path
